...
def FullYolo(input_size, weights):
    input_image = Input(shape=input_size)

    # the function to implement the organization layer (thanks to github.com/allanzelener/YAD2K)
    def space_to_depth_x2(inputs):
        return tf.compat.v1.space_to_depth(inputs, block_size=2)
    ...
    model = Model(input_image, x, name='Full_YOLO_backend')
